 ...
 */
export interface ECommerceSchemaUsersTable {
  id: number
  uuid: UUID
  email: string
  username: string
...
export type ECommerceSchemaUserProfilesTable = {
  id: number
  user_id: number
...
export type ECommerceSchema = {
  ...
  schemas: {
    public: {
      ...
      /** User accounts */
      users: ECommerceSchemaUsersTable

      /** User profile information */
      user_profiles: ECommerceSchemaUserProfilesTable
