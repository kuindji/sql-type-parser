/**
 * SELECT Query Examples Index
 *
 * Re-exports all SELECT query examples for easy importing.
 * These are demonstration files showing parser and matcher capabilities.
 */
