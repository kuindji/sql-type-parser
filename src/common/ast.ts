 ...
 * the result type from casting, and the original expression string for assembly
 */
 ...
 */
export type MapSQLTypeToTS<T extends string> = T extends
    ...
    : T extends "date" | "timestamp" | "timestamptz" | "time" | "timetz"
        ? string
