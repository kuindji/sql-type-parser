...
type P_WithColumns_Check = P_WithColumns extends SQLInsertQuery<infer Q>
  ? Q extends InsertClause<
      TableRef,
      InsertColumnList<[InsertColumnRef<"id">, InsertColumnRef<"name">, InsertColumnRef<"email">]>,
      any,
      any,
      any
    >
...
type P_ReturningCols_Check = P_ReturningCols extends SQLInsertQuery<infer Q>
  ? Q extends InsertClause<
      ...
      any,
      any,
      ReturningClause<[UnboundColumnRef<"id">, UnboundColumnRef<"name">]>
    >
    ? true
    : false
  : false
...
type P_QuotedCols_Check = P_QuotedCols extends SQLInsertQuery<infer Q>
  ? Q extends InsertClause<
      any,
      InsertColumnList<[InsertColumnRef<"firstName">, InsertColumnRef<"lastName">]>,
      any,
      any,
      any
    >
