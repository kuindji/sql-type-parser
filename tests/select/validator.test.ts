...
type V_Alias = ValidateSelectSQL<
...
type V_TableAlias = ValidateSelectSQL<
...
type V_TypeCast = ValidateSelectSQL<
...
type V_CurrentDate = ValidateSelectSQL<
...
type V_CurrentTimestamp = ValidateSelectSQL<
...
// Test: INTERVAL in WHERE clause validates successfully
type V_IntervalWhere_1 = ValidateSelectSQL<
    `SELECT *
    FROM users 
    WHERE 
    id > 10 and 
