...
type U_Simple_Check = U_Simple extends SQLSelectQuery<infer Q>
    ? Q extends UnionClause<SelectClause, "UNION", SelectClause> ? true
    : false
    : false;
...
type U_All_Check = U_All extends SQLSelectQuery<infer Q>
    ? Q extends UnionClause<SelectClause, "UNION ALL", SelectClause> ? true
    : false
    : false;
...
// Test: INTERSECT ALL
type I_All = ParseSQL<
    "SELECT id FROM users INTERSECT ALL SELECT id FROM active_users"
>;
type I_All_Check = I_All extends SQLSelectQuery<infer Q>
    ? Q extends UnionClause<SelectClause, "INTERSECT ALL", SelectClause> ? true
    : false
    : false;
...
// Test: EXCEPT
type E_Simple = ParseSQL<
    "SELECT id FROM users EXCEPT SELECT id FROM inactive_users"
>;
type E_Simple_Check = E_Simple extends SQLSelectQuery<infer Q>
    ? Q extends UnionClause<SelectClause, "EXCEPT", SelectClause> ? true
    : false
    : false;
...
// Test: EXCEPT ALL
type E_All = ParseSQL<
    "SELECT id FROM users EXCEPT ALL SELECT id FROM inactive_users"
>;
type E_All_Check = E_All extends SQLSelectQuery<infer Q>
    ? Q extends UnionClause<SelectClause, "EXCEPT ALL", SelectClause> ? true
    : false
    : false;
