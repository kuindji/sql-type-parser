...
type _P1 = RequireTrue<AssertExtends<P_SelectAll, SQLQuery>>

// Test: SELECT * has columns: "*"
type P_SelectAll_Columns = P_SelectAll extends SQLQuery<infer Q>
    ? Q extends { columns: "*" }
        ? true
        : false
    : false
...
type _P2 = RequireTrue<AssertExtends<P_SingleCol, SQLQuery>>

// Test: Multiple columns SELECT
type P_MultiCol = ParseSQL<"SELECT id, name, email FROM users">
type P_MultiCol_Columns = P_MultiCol extends SQLQuery<infer Q>
...
type P_ColAlias_Check = P_ColAlias extends SQLQuery<infer Q>
...
type P_TableAlias_Check = P_TableAlias extends SQLQuery<infer Q>
...
type P_TableCol_Check = P_TableCol extends SQLQuery<infer Q>
...
type P_Distinct_Check = P_Distinct extends SQLQuery<infer Q>
...
type P_NoDistinct_Check = P_NoDistinct extends SQLQuery<infer Q>
...
type P_SimpleTable_Check = P_SimpleTable extends SQLQuery<infer Q>
...
type P_SchemaTable_Check = P_SchemaTable extends SQLQuery<infer Q>
...
type P_QuotedTable_Check = P_QuotedTable extends SQLQuery<infer Q>
...
type P_QuotedSchemaTable_Check = P_QuotedSchemaTable extends SQLQuery<infer Q>
...
type P_InnerJoin_Check = P_InnerJoin extends SQLQuery<infer Q>
    ? Q extends { joins: [JoinClause<"INNER", TableRef, UnparsedExpr>] }
        ? true
        : false
    : false
...
type P_LeftJoin_Check = P_LeftJoin extends SQLQuery<infer Q>
    ? Q extends { joins: [JoinClause<"LEFT", TableRef, UnparsedExpr>] }
        ? true
        : false
    : false
...
type P_RightJoin_Check = P_RightJoin extends SQLQuery<infer Q>
    ? Q extends { joins: [JoinClause<"RIGHT", TableRef, UnparsedExpr>] }
        ? true
        : false
    : false
...
type P_FullJoin_Check = P_FullJoin extends SQLQuery<infer Q>
    ? Q extends { joins: [JoinClause<"FULL OUTER", TableRef, UnparsedExpr>] }
        ? true
        : false
    : false
...
type P_LeftOuterJoin_Check = P_LeftOuterJoin extends SQLQuery<infer Q>
    ? Q extends { joins: [JoinClause<"LEFT OUTER", TableRef, UnparsedExpr>] }
        ? true
        : false
    : false
...
`>
type P_MultiJoin_Check = P_MultiJoin extends SQLQuery<infer Q>
...
type P_PlainJoin_Check = P_PlainJoin extends SQLQuery<infer Q>
    ? Q extends { joins: [JoinClause<"INNER", TableRef, UnparsedExpr>] }
        ? true
        : false
    : false
...
type P_Where_Check = P_Where extends SQLQuery<infer Q>
...
type P_NoWhere_Check = P_NoWhere extends SQLQuery<infer Q>
...
type P_OrderBy_Check = P_OrderBy extends SQLQuery<infer Q>
...
type P_OrderByDesc_Check = P_OrderByDesc extends SQLQuery<infer Q>
...
type P_OrderByAsc_Check = P_OrderByAsc extends SQLQuery<infer Q>
    ? Q extends { orderBy: [OrderByItem<any, "ASC">] }
        ? true
        : false
    : false
...
type P_MultiOrder_Check = P_MultiOrder extends SQLQuery<infer Q>
...
type P_NoOrderBy_Check = P_NoOrderBy extends SQLQuery<infer Q>
...
type P_GroupBy_Check = P_GroupBy extends SQLQuery<infer Q>
...
type P_GroupByMulti_Check = P_GroupByMulti extends SQLQuery<infer Q>
...
type P_NoGroupBy_Check = P_NoGroupBy extends SQLQuery<infer Q>
...
type P_Having_Check = P_Having extends SQLQuery<infer Q>
...
type P_NoHaving_Check = P_NoHaving extends SQLQuery<infer Q>
...
type P_Limit_Check = P_Limit extends SQLQuery<infer Q>
    ? Q extends { limit: 10 }
        ? true
        : false
    : false
...
type P_LimitOffset_Limit = P_LimitOffset extends SQLQuery<infer Q>
    ? Q extends { limit: 10 }
        ? true
        : false
    : false
type P_LimitOffset_Offset = P_LimitOffset extends SQLQuery<infer Q>
    ? Q extends { offset: 20 }
        ? true
        : false
    : false
...
type P_OnlyOffset_Offset = P_OnlyOffset extends SQLQuery<infer Q>
    ? Q extends { offset: 5 }
        ? true
        : false
    : false
type P_OnlyOffset_Limit = P_OnlyOffset extends SQLQuery<infer Q>
...
type P_NoLimitOffset_Check = P_NoLimitOffset extends SQLQuery<infer Q>
...
type P_Count_Check = P_Count extends SQLQuery<infer Q>
...
type P_Sum_Check = P_Sum extends SQLQuery<infer Q>
...
type P_Avg_Check = P_Avg extends SQLQuery<infer Q>
...
type P_Min_Check = P_Min extends SQLQuery<infer Q>
...
type P_Max_Check = P_Max extends SQLQuery<infer Q>
...
type P_CountNoAlias_Check = P_CountNoAlias extends SQLQuery<infer Q>
...
type P_TableWildcard_Check = P_TableWildcard extends SQLQuery<infer Q>
...
type P_SchemaTableWildcard_Check = P_SchemaTableWildcard extends SQLQuery<infer Q>
...
`>
type P_CTE_Check = P_CTE extends SQLQuery<infer Q>
...
`>
type P_MultiCTE_Check = P_MultiCTE extends SQLQuery<infer Q>
...
type P_NoCTE_Check = P_NoCTE extends SQLQuery<infer Q>
...
`>
type P_DerivedTable_Check = P_DerivedTable extends SQLQuery<infer Q>
...
type P_TypeCast_Check = P_TypeCast extends SQLQuery<infer Q>
...
type P_JsonOp_Check = P_JsonOp extends SQLQuery<infer Q>
...
type P_ScalarSubquery = ParseSQL<`
  ...
  FROM users
`>
type P_ScalarSubquery_Check = P_ScalarSubquery extends SQLQuery<infer Q>
    ? Q extends {
...
type P_QuotedCol_Check = P_QuotedCol extends SQLQuery<infer Q>
    ? Q extends {
        columns: [
...
type P_QuotedBoth_Check = P_QuotedBoth extends SQLQuery<infer Q>
    ? Q extends {
...
type P_ThreePart_Check = P_ThreePart extends SQLQuery<infer Q>
...
type P_MixedCols = ParseSQL<`
  ...
  GROUP BY u.id
`>
type P_MixedCols_Check = P_MixedCols extends SQLQuery<infer Q>
    ? Q extends {
        columns: [
...
type P_Full = ParseSQL<`
  ...
  OFFSET 0
`>
type P_Full_Check = P_Full extends SQLQuery<infer Q>
    ? Q extends {
        distinct: true
        columns: [ColumnRef, ColumnRef, ColumnRef, ColumnRef]
        from: TableRef<"users", "u", undefined>
        joins: [JoinClause<"LEFT", TableRef, UnparsedExpr>]
        where: UnparsedExpr
...
type P_InvalidStart = ParseSQL<"INSERT INTO users VALUES (1)">
...
type _P61 = RequireTrue<AssertExtends<P_ExtraSpaces, SQLQuery>>
...
FROM
    users
`>
type _P62 = RequireTrue<AssertExtends<P_Newlines, SQLQuery>>

// Test: Tabs are handled
type P_Tabs = ParseSQL<"SELECT\tid\tFROM\tusers">
type _P63 = RequireTrue<AssertExtends<P_Tabs, SQLQuery>>
...
type _P64 = RequireTrue<AssertExtends<P_Lowercase, SQLQuery>>

// Test: Mixed case keywords
type P_MixedCase = ParseSQL<"Select Id From Users Where Active = True">
type _P65 = RequireTrue<AssertExtends<P_MixedCase, SQLQuery>>
